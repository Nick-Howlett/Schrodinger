module.exports = (client, member) => {
    client.playerdb.find_user(member.user.tag, row =>{
        if(row){
            ...
            member.send(`Welcome to the server! We don't recognize your discord tag! If you're interested in joining the human or zombie channels, please go to the current game's page at www.uchicagohvz.org and enter your discord tag! For reference, your discord tag is: ${member.user.tag}`);
        }
    });
}